...
class InstitucionalController extends Controller
{
    ...
    public function licitacoesEContrato()
    {
        ...
        $all = [];
        // $all['PROCESSOS LICITATÓRIOS EM ANDAMENTO'] = $licitacoes[1] ?? collect([]);
        $all[setting('admin.processos-licitatorios-em-concluidos', 'PROCESSOS LICITATÓRIOS CONCLUÍDOS')] = $licitacoes[0] ?? collect([]);
