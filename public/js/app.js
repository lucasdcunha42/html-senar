...
if ($('.carregar-mais-cursos').length) {
  ...
  var reloadAll = false;
  $.each([cursosAreaInteresseSelect, cursosregioesSelect, cursosAnoMesSelect], function (index, el) {
...
if ($('.sindicatos #municipios').length) {
  var changeResults = function changeResults() {
...
/***/ "./resources/js/state-city-select.js":
/*!*******************************************!*\
  !*** ./resources/js/state-city-select.js ***!
  \*******************************************/
/***/ (() => {
