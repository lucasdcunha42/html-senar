...
$wt_osenar_trabalhe_conoscos = $legado_mysqli->query('SELECT * FROM wt_osenar_trabalhe_conosco');
...
foreach( $wt_osenar_trabalhe_conoscos as $wt_osenar_trabalhe_conosco )
{
	...
	if (!$novo_mysqli->query( $insert )){
		...
		$wt_osenar_trabalhe_conosco_arquivos = $legado_mysqli->query('SELECT * FROM wt_osenar_trabalhe_conosco_arquivo WHERE id_trabalhe_conosco ='.$wt_osenar_trabalhe_conosco['id'].';');
