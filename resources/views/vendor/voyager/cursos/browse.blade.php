...
@section('page_header')
    <div class="container-fluid">
        ...
        @endcan
        <a id="open-loader" href="{{ route('xml.cursos.update') }}" class="btn btn-default btn-add-new">
            <i class="voyager-plus"></i> <span>Atualizar base local de cursos e requisitos</span>
        </a>
    ...
    @endif
    @if (session("error"))
    <div class="alert alert-warning" id="updated-alert">
        {{ session('error') }}
    </div> 
    @endif
@stop
