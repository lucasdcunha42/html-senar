...
@section('page_header')
    <div class="container-fluid">
        ...
        @endcan
        <a id="open-loader" href="{{ route('xml.sindicatos.update') }}" class="btn btn-default btn-add-new">
            <i class="voyager-plus"></i> <span>Atualizar base local de Sindicatos</span>
        </a>
