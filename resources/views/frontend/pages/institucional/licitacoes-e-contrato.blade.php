                    ...
                    <div class="accordion-container accordion-container-100">
                        <div class="accord-item">
                            <div class="accord-title">
                                <span>{{ setting('admin.processos-licita', 'PROCESSOS LICITATÓRIOS') }}</span>
                            ...
                            <div class="accord-desc">
                                <div class="texto html">
                                    <p>&nbsp;<a title="Licita&ccedil;&otilde;es em andamento" href="{{ setting('admin.link-externo-processos-licitarios-em-andamento') }}" target="_blank" rel="noopener noreferrer">Licita&ccedil;&otilde;es em andamento</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
