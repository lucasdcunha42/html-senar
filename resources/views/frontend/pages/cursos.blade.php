...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TWJF9K34"
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <div class="cursos-section cursos">
        <div class="container">
            ...
            <div class="row">
                <form action="{{route('page.cursos')}}" method="GET">
                    <div class="search-form" id="search-form">
                        <div class="search-bar">
                            <input type="text" name="q" id="nome_curso" placeholder="Pesquisa" class="custom-search">
